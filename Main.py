...
def enter_move(board):
	...
	while not ok:
		move = input("Escolha seu movimento: ") 
		ok = len(move) == 1 and move >= '1' and move <= '9' # a entrada do usuário é válida?
		if not ok:
			print("Numero não existe – Escolha o movimento certo!") # não, não é - faça a entrada novamente
			continue
		...
		if not ok:	#está ocupado - para a entrada novamente
			print("Essa jogada ja foi feita – Escolha o movimento certo!")
			continue
